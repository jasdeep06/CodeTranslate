...
String firstRow[] = {"~","1","2","3","4","5","6","7","8","9","0","-","+","Rub"};//BackSpace
String secondRow[] = {"Tab","क","ख","ग","घ","ङ","च","छ","ज","झ","ञ","[","]","\\"};
String thirdRow[] = {"Caps","ट","ठ","ड","ढ","ण","त","थ","द","ध",":","\"","Enter"};
String fourthRow[] = {"Shift","न","प","फ","ब","भ","म","य",",",".","?","   ^" };
String fifthRow[]={"      " ,"<" ,"\\/",">" };
...
public KeyBoard()
{
    ...
    Display.text.requestFocusInWindow();
